...
<Tabs defaultValue="cli">
  ...
  <TabsContent value="cli">
    ```bash
    npx prismui@latest add floating-action-panel
    ```
  </TabsContent>
...
FloatingActionPanel was created by [codehagen](https://twitter.com/codehagen). The component was designed to provide a flexible and elegant solution for floating action menus and forms. 