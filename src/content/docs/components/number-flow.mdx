...
summary: A smooth, animated number transition component with support for various formats and animations.
author: codehagen
...
<Tabs defaultValue="cli">
  ...
  <TabsContent value="manual">
    <Steps>
      <Step>Install the package using your preferred package manager.</Step>
      ```bash
      npm install @number-flow/react
      # or
      yarn add @number-flow/react
      # or
      pnpm add @number-flow/react
      ```
      <Step>Import and use the component in your project.</Step>
      ```tsx
...
| continuous | boolean | Enable continuous updates | false |
