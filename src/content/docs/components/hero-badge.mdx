...
<Tabs defaultValue="cli">
  ...
  <TabsContent value="cli">
    ```bash
    npx prismui@latest add hero-badge
    ```
  </TabsContent>
...
HeroBadge was created by [codehagen](https://twitter.com/codehagen). The component was designed to provide an elegant solution for highlighting important information with modern UI patterns. 