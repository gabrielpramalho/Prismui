...
async function getGithubStats(): Promise<Stats> {
  try {
...
function GitHubStatsContent({ stars, contributors }: Stats) {
  return (
    <section className="container relative py-20">
      ...
      <div className="max-w-4xl mx-auto">
        <GithubCard stars={stars} contributors={contributors} />
      </div>
    </section>
  );
}
...
async function GitHubStatsData() {
  ...
  return <GitHubStatsContent {...stats} />;
}
